...
class Shader1110(shader_1100.Shader1100):
    ...
    def build(self, context):
        ...
        decal_uv = tree.add_node("ShaderNodeUVMap", (6, 20))
        decal_uv.label = "Decal UV"
        decal_uv.uv_map = "UVChannel_3"

        decal = tree.add_node("ShaderNodeTexImage", (12, 20))
        decal.label = "Decal"
        decal.image = self.textures.decal.diffuse
        decal.extension = "CLIP"

        decal_mix = tree.add_node("ShaderNodeMix", (18, 16))
